    ...
    'installer' => [
        ...
        'index' => [
            ...
            'installation-completed' => [
                'admin-panel' => '管理パネル',
                'bagisto-forums' => 'Frooxiフォーラム',
                'customer-panel' => '顧客パネル',
                'explore-bagisto-extensions' => 'Frooxi拡張機能の探索',
                'title' => 'インストールが完了しました',
                'title-info' => 'Frooxiがシステムに正常にインストールされました。',
            ],
            ...
            'hindi' => 'ヒンディー語',
            'indonesian' => 'インドネシア語',
            'installation-description' => 'Frooxiのインストールには通常、いくつかのステップが含まれます。 ここにFrooxiのインストールプロセスの一般的な概要があります',
            'installation-info' => 'ここにいてくれてうれしいです！',
            'installation-title' => 'Frooxiインストールへようこそ',
            'italian' => 'イタリア語',
            'japanese' => '日本語',
            'persian' => 'ペルシャ語',
            'polish' => 'ポーランド語',
