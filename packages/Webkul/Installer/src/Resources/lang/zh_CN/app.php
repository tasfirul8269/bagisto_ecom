    ...
    'installer' => [
        ...
        'index' => [
            ...
            'installation-completed' => [
                'admin-panel' => '管理员面板',
                'bagisto-forums' => 'Frooxi 论坛',
                'customer-panel' => '客户面板',
                'explore-bagisto-extensions' => '探索 Frooxi 扩展',
                'title' => '安装已完成',
                'title-info' => 'Frooxi 已成功安装在您的系统上。',
            ],
            ...
            'hindi' => '印地语',
            'indonesian' => '印尼语',
            'installation-description' => 'Frooxi 的安装通常涉及几个步骤。以下是 Frooxi 安装过程的一般概述',
            'installation-info' => '我们很高兴在这里见到你！',
            'installation-title' => '欢迎安装 Frooxi',
            'italian' => '意大利语',
            'japanese' => '日语',
            'persian' => '波斯语',
            'polish' => '波兰语',
