                                ...
                                <div class="grid gap-4 md:hidden">
                                    ...
                                    >
                                        ...
                                        <div class="grid gap-1.5 rounded-md rounded-t-none border border-t-0 bg-white px-4 py-3 text-xs font-medium">
                                            ...
                                            {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.subtotal.before') !!}
                                            ...
                                            {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.subtotal.after') !!}

                                            {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.shipping.before') !!}
                                            ...
                                            {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.shipping.after') !!}

                                            {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.discount.before') !!}
                                            ...
                                            {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.discount.after') !!}

                                            {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.tax.before') !!}
                                            ...
                                            {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.tax.after') !!}

                                            {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.grand-total.before') !!}
                                            ...
                                            {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.grand-total.after') !!}
                                    ...
                                    <div class="mt-8 flex items-start gap-10 max-lg:gap-5">
                                        <div class="flex flex-auto justify-end">
                                            <div class="grid max-w-max gap-2 text-sm">
                                                ...
                                                {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.tax-amount.before') !!}
                                                ...
                                                {!! view_render_event('frooxi.shop.customers.account.orders.view.invoices.tax-amount.after') !!}
                            ...
                            <div class="grid gap-4 md:hidden">
                                ...
                                >
                                    ...
                                    <div class="grid gap-1.5 rounded-md rounded-t-none border border-t-0 bg-white px-4 py-3 text-xs font-medium">
                                        ...
                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.subtotal.before') !!}
                                        ...
                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.subtotal.after') !!}

                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.shipping.before') !!}
                                        ...
                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.shipping.after') !!}

                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.discount.before') !!}
                                        ...
                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.discount.after') !!}

                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.tax-amount.before') !!}
                                        ...
                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.tax-amount.after') !!}

                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.adjustment-refund.before') !!}
                                        ...
                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.adjustment-refund.after') !!}

                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.adjustment-fee.before') !!}
                                        ...
                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.adjustment-fee.after') !!}

                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.grand-total.before') !!}
                                        ...
                                        {!! view_render_event('frooxi.shop.customers.account.orders.view.refunds.grand-total.after') !!}
