@pushOnce('scripts')
    ...
    >
        <div class="mt-2 max-md:mt-3">
            ...
            {!! view_render_event('frooxi.shop.checkout.onepage.address.form.company_name.after') !!}
            ...
            <template v-if="controlName=='billing'">
                ...
                {!! view_render_event('frooxi.shop.checkout.onepage.address.form.vat_id.after') !!}
            </template>
            ...
            <div class="grid grid-cols-2 gap-x-5 max-md:grid-cols-1">
                ...
                {!! view_render_event('frooxi.shop.checkout.onepage.address.form.state.after') !!}
            </div>
            ...
            <div class="grid grid-cols-2 gap-x-5 max-md:grid-cols-1">
                ...
                {!! view_render_event('frooxi.shop.checkout.onepage.address.form.postcode.after') !!}
            </div>
