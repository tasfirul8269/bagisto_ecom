...
@pushOnce('scripts')
    ...
    >
        <div class="flex justify-between text-right">
            ...
            {!! view_render_event('frooxi.shop.checkout.cart.coupon.before') !!}
            ...
            <p class="text-base font-medium max-sm:text-sm">
                ...
                >
                    ...
                    <form @submit="handleSubmit($event, applyCoupon)">
                        {!! view_render_event('frooxi.shop.checkout.cart.coupon.coupon_form_controls.before') !!}
                        ...
                        <x-shop::modal ref="couponModel">
                            ...
                            <x-slot:toggle>
                                <span 
                                    class="cursor-pointer text-sm font-medium text-black underline underline-offset-2 max-sm:text-sm"
                                    role="button"
                                    tabindex="0"
                            ...
                            <x-slot:footer>
                                ...
                                <div class="flex flex-wrap items-center gap-4 max-md:justify-between">
                                    ...
                                    <x-shop::button
                                        class="primary-button max-w-none flex-auto rounded-[5px] bg-black px-8 py-3 text-sm font-medium text-white max-md:max-w-[153px] max-md:py-2"
                        ...
                        {!! view_render_event('frooxi.shop.checkout.cart.coupon.coupon_form_controls.after') !!}
                    </form>
                </x-shop::form>
                ...
                >
                    ...
                    <span 
                        class="icon-cancel cursor-pointer text-xl text-black max-sm:text-base"
            ...
            {!! view_render_event('frooxi.shop.checkout.cart.coupon.after') !!}
        </div>
    </script>
